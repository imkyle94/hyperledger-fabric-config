...
function registerEnroll() {
    ...
    cp ${TEST_NETWORK_HOME}/organizations/peerOrganizations/org1.example.com/connection-org1.json /Users/park/test/bridge-monitoring-server
    rm -rf /Users/park/test/bridge-monitoring-server/wallet
}
...
function main() {
    ...
    echo "finished to create genesis block"
    sleep 1
    createChannelTx mdlll Org1Org2Org3Channel
    echo "finished to create channel tx"
    sleep 1
    createChannelTx mdl Org1Org2Channel
    echo "finished to create channel tx"
    sleep 1
    ...
    # echo "finished to join channel org3"
    # sleep 1
    # setAnchorPeer mdlll org1
    # echo "finished to set anchor peer org1"
    # sleep 1
    setAnchorPeer mdl org2
    echo "finished to set anchor peer org2"
    sleep 1
    # setAnchorPeer mychannel-b org3
    # echo "finished to set anchor peer org3"
    # sleep 1
    # deployChaincode --cc STO --ch mdlll --i org1 --i org2 --i org3 --ap org1 --ap org2 --ap org3 --check org1 --check org2 --check org3 --c org1
    # echo "finished to deploy chaincode"
    # sleep 5
    deployChaincode --cc ethswap --ch mdl --i org1 --i org2 --ap org1 --ap org2 --check org1 --check org2 --c org1
    echo "finished to deploy chaincode"
    sleep 5
    deployChaincode --cc validatorinfo --ch mdl --i org1 --i org2 --ap org1 --ap org2 --check org1 --check org2 --c org1
    echo "finished to deploy chaincode"
    sleep 5
    # deployChaincode --cc STO --ch mychannel-b --ap org1 --ap org3 --check org1 --check org3 --c org3
    # echo "finished to deploy chaincode"
    # sleep 5
    # deployChaincode --cc Dev --ch mdlll --i org1 --i org2 --i org3 --ap org1 --ap org2 --ap org3 --check org1 --check org2 --check org3 --c org1
    # echo "finished to deploy chaincode"
    # sleep 5
    # deployChaincode --cc ethswap --ch mdl --i org1 --i org2 --ap org1 --ap org2 --check org1 --check org2 --c org1
    # echo "finished to deploy chaincode"
    # sleep 5
    # deployChaincode --cc Dev --ch mdl --ap org1 --ap org2 --check org1 --check org2 --c org1
    # echo "finished to deploy chaincode"
    # sleep 5
