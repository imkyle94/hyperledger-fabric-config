...
function main() {
    # ch1
    deployChaincode ch1 chaincodematchinginfo 1.0 1
    deployChaincode ch1 validation 1.0 1
    deployChaincode ch1 ethswap 1.0 1
    deployChaincode ch1 mdlminter 1.0 1
    deployChaincode ch1 addressinfo 1.0 1
    # ch2
    deployChaincode ch2 chaincodematchinginfo 1.0 1
    deployChaincode ch2 validation 1.0 1
    deployChaincode ch2 ethswap 1.0 1
    deployChaincode ch2 mdlminter 1.0 1
    deployChaincode ch2 addressinfo 1.0 1
}
