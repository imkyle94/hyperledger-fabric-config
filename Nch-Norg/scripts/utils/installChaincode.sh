...
function setChaincode() {
    ...
    if [ -d ${TEST_NETWORK_HOME}/chaincodes/ethswap ]; then
        rm -rf ${TEST_NETWORK_HOME}/chaincodes/ethswap
        mkdir -p ${TEST_NETWORK_HOME}/chaincodes/ethswap
        cp -r "/Users/park/test/bridge-chaincode/ethswap" ${TEST_NETWORK_HOME}/chaincodes/ethswap
        mv ${TEST_NETWORK_HOME}/chaincodes/ethswap/ethswap ${TEST_NETWORK_HOME}/chaincodes/ethswap/go
    else
        mkdir -p ${TEST_NETWORK_HOME}/chaincodes/ethswap
        cp -r "/Users/park/test/bridge-chaincode/ethswap" ${TEST_NETWORK_HOME}/chaincodes/ethswap
        mv ${TEST_NETWORK_HOME}/chaincodes/ethswap/ethswap ${TEST_NETWORK_HOME}/chaincodes/ethswap/go
    fi
    if [ -d ${TEST_NETWORK_HOME}/chaincodes/validatorinfo ]; then
        rm -rf ${TEST_NETWORK_HOME}/chaincodes/validatorinfo
        mkdir -p ${TEST_NETWORK_HOME}/chaincodes/validatorinfo
        cp -r "/Users/park/test/bridge-chaincode/validatorinfo" ${TEST_NETWORK_HOME}/chaincodes/validatorinfo
        mv ${TEST_NETWORK_HOME}/chaincodes/validatorinfo/validatorinfo ${TEST_NETWORK_HOME}/chaincodes/validatorinfo/go
    else
        mkdir -p ${TEST_NETWORK_HOME}/chaincodes/validatorinfo
        cp -r "/Users/park/test/bridge-chaincode/validatorinfo" ${TEST_NETWORK_HOME}/chaincodes/validatorinfo
        mv ${TEST_NETWORK_HOME}/chaincodes/validatorinfo/validatorinfo ${TEST_NETWORK_HOME}/chaincodes/validatorinfo/go
...
function main() {
    ...
    deployChaincode --v v5 --s 5 --cc ethswap --ch mdl --i org1 --i org2 --ap org1 --ap org2 --check org1 --check org2 --c org1
    echo "finished to deploy chaincode"
    sleep 5

    # deployChaincode --v v2 --s 2 --cc validatorinfo --ch mdl --i org1 --i org2 --ap org1 --ap org2 --check org1 --check org2 --c org1
    # echo "finished to deploy chaincode"
    # sleep 5
